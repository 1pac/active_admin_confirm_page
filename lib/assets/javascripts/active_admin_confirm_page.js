...
function onSubmit(event, xhr, settings) {
  // Create an iframe for the target of the validation request with specifying
  // style to move the iframe offscreen.
  $('body').append('<iframe name="uploadiframe" id="uploadiframe" style="position:absolute;left:-5000px"></iframe>');
...
// Do not insert a confirm page for admin_user.
if (form.hasClass('admin_user')) return;

// Do insert a confirm page for other resources.
form.on('submit', onSubmit);
